...
function buildHeader() {
    const inPages = window.location.pathname.includes('/pages/');
    const logoPath = inPages ? '../assets/images/logo.png' : './assets/images/logo.png';
    return `
    <style>
        .nav-social-btn {
            display: inline-flex;
        ...
        .nav-social-btn--linkedin:hover {
            ...
            box-shadow: 0 0 14px rgba(10,102,194,0.55);
            color: #60a8ff;
        }
        /* Light mode: visible dark borders/icons */
        [data-theme="light"] .nav-social-btn {
            background: rgba(0,0,0,0.04);
            border: 1px solid rgba(0,0,0,0.14);
            color: rgba(0,0,0,0.55);
        }
        [data-theme="light"] .nav-social-btn:hover {
            background: rgba(124,58,237,0.08);
            border-color: rgba(124,58,237,0.45);
            color: #7c3aed;
            box-shadow: 0 0 12px rgba(124,58,237,0.3);
        }
        [data-theme="light"] .nav-social-btn--linkedin:hover {
            background: rgba(10,102,194,0.08);
            border-color: rgba(10,102,194,0.45);
            color: #0a66c2;
            box-shadow: 0 0 12px rgba(10,102,194,0.3);
        }
        @media (max-width: 768px) { .nav-social-btn { display: none; } }
    </style>
    ...
    <header class="header" id="site-header-el">
        <div class="header-inner">
            <a href="${resolveRelativePath('index.html')}" class="logo">
                <img src="${logoPath}" alt="Logo" class="nav-logo-img" style="height: 32px; width: auto; object-fit: contain; margin-right: 8px;">
            ...
            <div class="header-actions">
                <a href="https://github.com/Mamdouh-Attia" target="_blank" rel="noopener" class="nav-social-btn" aria-label="GitHub" title="GitHub">
                ...
                <a href="https://www.linkedin.com/in/mamdouh-atia/" target="_blank" rel="noopener" class="nav-social-btn nav-social-btn--linkedin" aria-label="LinkedIn" title="LinkedIn">
...
function buildFooter() {
    ...
    <!-- Global CV Selection Modal -->
    <div class="cv-modal-overlay" id="cv-modal" onclick="this.classList.remove('active')">
      <div class="cv-modal-content" onclick="event.stopPropagation()">
        <button class="cv-modal-close" onclick="document.getElementById('cv-modal').classList.remove('active')" aria-label="Close">×</button>
        ...
        <div class="cv-options">
          <a href="${resolveRelativePath('assets/CV/Mamdouh_Attia_Software_Engineer_CV.pdf')}" class="cv-option-card" download>
            ...
            <div class="cv-info">
              <h4 data-i18n="cv.sweTitle">Software Engineer</h4>
              <span data-i18n="cv.sweDesc" style="font-size: 13px; color: var(--text-muted);">General CS & Backend</span>
            </div>
          </a>
          ...
          <a href="${resolveRelativePath('assets/CV/Mamdouh_Attia_Mobile_Software_Engineer.pdf')}" class="cv-option-card" download>
            ...
            <div class="cv-info">
              <h4 data-i18n="cv.mobileTitle">Mobile Software Engineer</h4>
              <span data-i18n="cv.mobileDesc" style="font-size: 13px; color: var(--text-muted);">Flutter & Architectures</span>
            </div>
          </a>
        </div>
      </div>
